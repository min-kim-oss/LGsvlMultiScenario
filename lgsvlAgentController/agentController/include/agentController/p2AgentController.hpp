...
class P2AgentController : public rclcpp::Node
{
  private:
    rclcpp::TimerBase::SharedPtr timer_control_;
    rclcpp::Subscription<std_msgs::msg::Char>::SharedPtr p2_key_sub;
  ...
  public:
    explicit P2AgentController(const rclcpp::NodeOptions &);
